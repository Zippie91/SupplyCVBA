...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM products WHERE prod_id=%s",
  ...
  $deleteGoTo = "prod.php?cat=" . $_GET['cat'];
...
<div class="container">
  ...
  <div class="content">
    <h1>Bezig met verwijderen van het product</h1>
    	<p>Verwijderen...</p>
  </div>
   	<!-- end .content -->
  </div>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($KlantenQuery);
?>
