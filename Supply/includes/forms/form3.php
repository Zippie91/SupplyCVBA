...
$query_ProdBoven1 = sprintf("SELECT * FROM products WHERE products.prod_plaats = 'boven' AND products.prod_kleur = '1' AND products.prod_categorie = %s AND products.prod_actief = '1'", GetSQLValueString($prod_var_ProdBoven1, "int"));
