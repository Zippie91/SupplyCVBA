...
<ul class="catlijst">
    <?php do { ?>
	<li><a href="../adminweb/prod.php?cat=<?php echo $row_CEMol['cat_id']; ?>"><?php echo $row_CEMol['cat_beschrijving']; ?></a></li>
      <?php } while ($row_CEMol = mysql_fetch_assoc($CEMol)); ?>
</ul>
<h5>Tanden</h5>
<ul class="catlijst">
	<?php do { ?>
	  <li><a href="../adminweb/prod.php?cat=<?php echo $row_CETand['cat_id']; ?>"><?php echo $row_CETand['cat_beschrijving']; ?></a></li>
...
<ul class="catlijst">
	<?php do { ?>
	  <li><a href="../adminweb/prod.php?cat=<?php echo $row_CRMol['cat_id']; ?>"><?php echo $row_CRMol['cat_beschrijving']; ?></a></li>
	  <?php } while ($row_CRMol = mysql_fetch_assoc($CRMol)); ?>
</ul>
<h5>Tanden</h5>
<ul class="catlijst">
	<?php do { ?>
	  <li><a href="../adminweb/prod.php?cat=<?php echo $row_CRTand['cat_id']; ?>"><?php echo $row_CRTand['cat_beschrijving']; ?></a></li>
