...
function BuildUserInfo() {
    ...
    $users = "  <table class=\"article-content\" cellspacing=\"1px\" cellpadding=\"2px\" border=\"0\" align=\"center\" style='margin: 0 auto;width: 540px;'>
                    <tr>
                        <td align=\"right\">Klantnaam:</td>
                        <td width=\"5px\">&nbsp;</td>
                        <td>"; 
        $users .= $_POST['naam']; 
        $users .="      </td>
                    ...
                    <tr>
                        ...
                        <td width=\"5px\">&nbsp;</td>
                        <td>";
        $users .= $_POST['straat'] . " " . $_POST['nummer'] . " " . $_POST['bus'];               
        $users .= "     </td>
                    </tr>
                    <tr>
                        <td align=\"right\"></td>
                        <td width=\"5px\">&nbsp;</td>
                        <td>";
        $users .= $_POST['postcode'] . " " . $_POST['plaats'];               
        $users .= "     </td>
                        <td width=\"200px\">&nbsp;</td>
                    </tr>
                    <tr>
        ...
        $users .= "     </td>
                    ...
                    <tr>
                        <td align=\"right\">Ondernemingsnummer:</td>
                        <td width=\"5px\">&nbsp;</td>
                        <td>";
        $users .= $_POST['btw'];               
        $users .= "     </td>
...
function BuildHTMLEmail() {
    $email = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html><head><title></title><meta content=\"text/html; charset=utf-8\" http-equiv=\"Content-Type\"><meta name=\"viewport\" content=\"width=320, target-densitydpi=device-dpi\">
<style type=\"text/css\">
...
#street-address { color: #e7cba3; white-space: normal; }
...
</head><body style=\"color: #000\"><table id=\"background-table\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">
	<tbody><tr>
		<td bgcolor=\"#ececec\" align=\"center\">
        	<table style=\"margin: 0px 10px;\" class=\"w640\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"640\">
            	<tbody><tr><td class=\"w640\" height=\"20\" width=\"640\"></td></tr>
                
            	<tr>
                	<td class=\"w640\" width=\"640\">
                        <table id=\"top-bar\" class=\"w640\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"640\" bgcolor=\"#043948\" style=\"color:\"#e2e2e2\";\">
    <tbody><tr>
        <td class=\"w325\" valign=\"middle\" width=\"350\" align=\"left\">
            ...
            <div class=\"header-content\"><webversion>&nbsp;</webversion></div>
            <table class=\"w325\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"350\">
                <tbody><tr><td class=\"w325\" height=\"8\" width=\"350\"></td></tr>
            </tbody></table>
        </td>
    ...
    <tbody><tr>
        ...
        <td class=\"w15\" width=\"15\"></td>
                ...
                <tr>
                    <td id=\"header\" class=\"w640\" bgcolor=\"#0093d3\" width=\"640\" align=\"center\">
                        <div style=\"text-align: center;\" align=\"center\">
                            <a href=\"http://www.supplycvba.be\">
                            <img style=\"display: inline;\" id=\"customHeaderImage\" class=\"w640\" border=\"0\" align=\"top\" src=\"http://www.supplycvba.be/images/emailheader/header_new2.png\" width=\"540\" label=\"Header Image\" editable=\"true\">
                            </a>
                        </div>
                    </td>
                </tr>
    ...
    <table class=\"w640\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"640\">
        <tbody><tr>
            <td class=\"w30\" width=\"30\"></td>
                ...
                <repeater>
                    ...
                    <layout label=\"Text only\">
                        <table class=\"w580\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"580\">
                            <tbody><tr>
                                <td class=\"w580\" width=\"580\">
                                    <p class=\"article-title\" align=\"left\"><singleline label=\"Title\">Bedankt voor uw bestelling.</singleline></p>
    ...
    $email .=               "</td></tr>
            ...
            <td class=\"w30\" width=\"30\"></td>
                ...
                <tr>
                <td class=\"w640\" width=\"640\">
    <table id=\"footer\" class=\"w640\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"640\" bgcolor=\"#043948\">
        <tbody><tr><td class=\"w30\" width=\"30\"></td><td class=\"w580 h0\" height=\"10\" width=\"360\"></td><td class=\"w0\" width=\"60\"></td><td class=\"w0\" width=\"160\"></td><td class=\"w30\" width=\"30\"></td></tr>
        <tr>
            <td class=\"w30\" width=\"30\"></td>
            <td class=\"w580\" valign=\"top\" width=\"360\">
            <span class=\"hide\"><p id=\"permission-reminder\" class=\"footer-content-left\" align=\"left\"></p></span>
            <p class=\"footer-content-left\" align=\"left\"><preferences lang=\"nl-NL\"><a href=\"http://www.supplycvba.be\">Supply CVBA</a></p>
            </td>
            <td class=\"hide w0\" width=\"60\"></td>
            <td class=\"hide w0\" valign=\"top\" width=\"160\">
            <p id=\"street-address\" class=\"footer-content-right\" align=\"right\"><span>Matteottistraat 65</span><br>
<span> 2845 Niel</span><br>
<span> Belgi&euml; </span><br>
<span></span><br>
<span>Tel.: +32(0)3 888 68 61</span><br>
<span> GSM: +32(0)483 08 33 22 </span></p>
            </td>
            <td class=\"w30\" width=\"30\"></td>
        </tr>
