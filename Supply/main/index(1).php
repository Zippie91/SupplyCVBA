...
<div class="container">
  ...
  <div class="nav">
  	<div class="main_menu"><!-- InstanceBeginEditable name="Edit current class" -->
  	  <ul class="bluebar">
  	    ...
  	    <li><a href="../main/#" title="Producten"><span>Producten</span></a></li>
  	    <li><a href="../main/#" title="Contact"><span>Contact</span></a></li>
      </ul>
  ...
  <!-- InstanceBeginEditable name="Content" -->
    ...
    <h2>Deze website is momenteel nog in productie.<br /> Binnenkort kan u via deze weg uw bestellingen plaatsen.</h2>
	...
	<p>De A1 &ndash; D4 benaming correspondeert met de Vita kleuring. Dit is bedoeld als oriëntatie, niet als vergelijking. Vita is geen geregistreed merk van Enta (Pritidenta).</p>
